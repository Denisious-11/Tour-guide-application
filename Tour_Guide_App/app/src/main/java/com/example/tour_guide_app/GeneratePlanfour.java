...
public class GeneratePlanfour extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_generate_planfour);
        ...
        tv8=(TextView)findViewById(R.id.tv11);
        tv9=(TextView)findViewById(R.id.tv12);
        tv10=(TextView)findViewById(R.id.tv13);
        ...
        b1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent i2=new Intent(GeneratePlanfour.this,SearchPlace.class);
                startActivity((i2));
            }
        });
        ...
        tv4.setText("Visiting "+val_1);
        tv5.setText("Visiting "+val_2);
        tv6.setText("Visiting "+val_2);
        tv7.setText("Visiting "+val_3);
        tv8.setText("Visiting "+val_3);
        tv9.setText("Visiting "+val_4);
        tv10.setText("Visiting "+val_4);
        ...
        b2.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent i2=new Intent(GeneratePlanfour.this,GiveRatingtwo.class);
