...
public class GeneratePlantwo extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_generate_plantwo);
        ...
        b1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent i2=new Intent(GeneratePlantwo.this,SearchPlace.class);
                startActivity((i2));
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent i2=new Intent(GeneratePlantwo.this,GiveRatingtwo.class);
