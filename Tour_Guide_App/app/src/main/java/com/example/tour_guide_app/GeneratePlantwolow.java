...
public class GeneratePlantwolow extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_generate_plantwolow);
        ...
        b1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent i2=new Intent(GeneratePlantwolow.this,SearchPlace.class);
                startActivity((i2));
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent i2=new Intent(GeneratePlantwolow.this,GiveRatingtwo.class);
